...
output: 
  rjtools::rjournal_web_article:
    bibliography: [penguins.bib, packages.bib]
resource_files:
  - packages.bib
  - penguins.bib
---
...
All analyses were performed in the R language environment using version 3.6.2 [@R-base]. Complete code for this paper is shared in the Supplemental Material. We acknowledge the following R packages used in analyses, with gratitude to developers and contributors:
...
-   \CRANpkg{recipes} [@R-recipes]: for data pre-processing
-   **base** and **stats** [@R-base]: for various analyses throughout
