...
\textbf{iris} to eugenics research. Thus, a modern alternative to the
\textbf{iris} dataset is needed. In this paper, we introduce the
palmerpenguins R package, which includes body size measurements
collected from 2007 - 2009 for three species of Pygoscelis penguins that
breed on islands throughout the Palmer Archipelago, Antarctica. The
\textbf{penguins} data provides an approachable, charismatic, and near
...
been downloaded over 238,000 times, highlighting the demand and
