...
```{r linear-example, opts.label = 'fig.pdf'}
#| width: 6
#| height: 3
#| fig.pos: 'htbp'
...
```{r linear-web, opts.label= c('linear-example', 'fig.web')}
